...
# Aglomerar por Filo
absolute_phylum <- tax_glom(merged_metagenomes, taxrank = 'Phylum')
# Convertir a dataframe
phylum_df_absolute <- psmelt(absolute_phylum)
# Exportar a CSV
write.csv(phylum_df_absolute, 'phylum_df_absolute.csv', row.names = FALSE)

# Aglomerar por Orden
absolute_orden <- tax_glom(merged_metagenomes, taxrank = 'Order')
# Convertir a dataframe
order_df_absolute <- psmelt(absolute_orden)
# Exportar a CSV
write.csv(order_df_absolute, 'order_df_absolute.csv', row.names = FALSE)

# Aglomerar por Género
absolute_genus <- tax_glom(merged_metagenomes, taxrank = 'Genus')
# Convertir a dataframe
genus_df_absolute <- psmelt(absolute_genus)
# Exportar a CSV
write.csv(genus_df_absolute, 'genus_df_absolute.csv', row.names = FALSE)
